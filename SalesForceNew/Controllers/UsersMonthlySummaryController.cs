...
{
    public class UsersMonthlySummaryController : ApiController
    {
        ...
        public List<SalesSummary1> Get(int id)
        {
            using (SalesForceEntities entities = new SalesForceEntities())
            {
                ...
                List<UsersSalesSummary_Result> l1 = new List<UsersSalesSummary_Result>();
...

                {
                    ...
                    try
                    {
                        l1 = (entities.UsersSalesSummary(id, x, y).ToList());
                         int c = l1.Count();
                        int d = 0;
